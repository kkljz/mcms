		...
		if(check()){
			$.ajax({
			    ...
			    success : function(data){
					...
					window.location.replace('${basePath}/AnnouncementList');
				},
				error : function(){
					alert("亲，添加失败了，不开森");
				}
...
<div class="place">
    ...
    <li><label>&nbsp;</label><input name="" type="reset" class="btn btn-info" value="确认添加" onclick="addAnnouncement();"/> <input name="" type="reset" class="btn btn-danger" value="取消" /></li>
    </ul>
    </form>
    </div>
