...
<div class="formbody">
    ...
    <input type="hidden" name="userId" id="userId" value="${loginuser.userId }"></input><br/>
    <ul class="forminfo">
    ...
    <li class="click"><label>&nbsp;</label><input name="" type="button" class="button btn-info" value="确认修改" onclick="changePwd();"/> &nbsp;&nbsp;&nbsp;<input name="" type="reset" class="button btn-info" value="取消" /></li>
    </ul>
    </form>
</div>
